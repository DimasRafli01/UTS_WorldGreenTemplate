        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?page=landing#">Beranda</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?page=produk#produk">Produk Kami</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?page=landing#tes1">Testimoni</a>
                    </li>
                    <li class="nav-item">
